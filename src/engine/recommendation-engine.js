...
export function createLaunchRecommendation({ evaluateDecision, seasonalityRows }) {
  ...
  return {
    ...
    tradeoff: "LUMEN is choosing faster payback and stronger margins over maximum reach and retail availability: the 60% DTC / 20% Retail / 20% Gym mix keeps retail present while prioritising higher-contribution channels.",
